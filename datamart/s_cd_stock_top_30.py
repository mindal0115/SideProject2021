...
try:
    cursor.execute('drop table mid_table.s_cd_stock_top_30')
    print('table deleted')
except:
    pass
...
q = '''
create table if not exists mid_table.s_cd_stock_top_30 as 
...
where b.sector = 'Consumer Defensive'
order by 5 desc
limit 30
;
'''
cursor.execute(q)
conn.close()
print('s_cd_stock_top_30 table craeted')